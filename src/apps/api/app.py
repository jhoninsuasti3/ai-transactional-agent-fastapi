...
from src.apps.api.exception_handlers.handlers import register_exception_handlers
from src.apps.api.health.router import health_router
from src.apps.api.middlewares.logging import LoggingMiddleware
from src.apps.api.middlewares.request_id import RequestIDMiddleware
from src.apps.v1.routers.router import api_v1_router
from src.config.databases.postgres import close_db
