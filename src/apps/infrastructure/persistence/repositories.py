...
from src.apps.core.exceptions import NotFoundError
from src.apps.domain.models import Conversation, ConversationStatus, Transaction
from src.apps.domain.ports.repository_port import (
    ConversationRepository,
    TransactionRepository,
)
from src.apps.infrastructure.persistence.models import ConversationORM, TransactionORM
