...
from apps.domain.models import Conversation, ConversationStatus, Transaction
from apps.domain.ports.repository_port import (
    ConversationRepository,
    TransactionRepository,
)
from apps.infrastructure.persistence.models import ConversationORM, TransactionORM
