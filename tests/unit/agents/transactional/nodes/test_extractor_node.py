...
class TestExtractorNode:
    ...
    def test_extractor_extracts_phone_and_amount(self):
        ...
        state = {"messages": [HumanMessage(content="Quiero enviar 50000 pesos al 3001234567")]}
    ...
    def test_extractor_extracts_phone_only(self):
        ...
        state = {"messages": [HumanMessage(content="Al 3009876543")]}
    ...
    def test_extractor_extracts_amount_only(self):
        ...
        state = {"messages": [HumanMessage(content="75000 pesos")]}
    ...
    def test_extractor_extracts_amount_with_dollar_sign(self):
        ...
        state = {"messages": [HumanMessage(content="Enviar $10,000 al 3001112233")]}
    ...
    def test_extractor_ignores_phone_not_starting_with_3(self):
        ...
        state = {"messages": [HumanMessage(content="Enviar 50000 pesos al 5001234567")]}
    ...
    def test_extractor_handles_amount_with_commas(self):
        ...
        state = {"messages": [HumanMessage(content="Enviar $50,000 pesos al 3001234567")]}
    ...
    def test_extractor_handles_amount_with_monto_keyword(self):
        ...
        state = {"messages": [HumanMessage(content="monto: 100000, número 3001234567")]}
    ...
    def test_extractor_handles_enviar_keyword(self):
        ...
        state = {"messages": [HumanMessage(content="envía 25,000 al 3005555555")]}
    ...
    def test_extractor_handles_transferir_keyword(self):
        ...
        state = {"messages": [HumanMessage(content="transferir 33,000 al número 3007777777")]}
    ...
    def test_extractor_takes_first_match_for_phone(self):
        ...
        state = {"messages": [HumanMessage(content="Al 3001111111 o al 3002222222")]}
    ...
    def test_extractor_takes_first_match_for_amount(self):
        ...
        state = {"messages": [HumanMessage(content="50000 pesos o 75000 pesos")]}
    ...
    def test_extractor_handles_non_string_content(self):
        ...
        mock_message = type("MockMessage", (), {"content": CustomContent()})()
    ...
    def test_extractor_case_insensitive_keywords(self):
        ...
        state = {"messages": [HumanMessage(content="ENVIAR 60000 PESOS al 3008888888")]}
    ...
    def test_extractor_only_extracts_10_digit_phones(self):
        ...
        state = {
            "messages": [HumanMessage(content="Números: 300123456 y 30012345678 y 3001234567")]
        }
    ...
    def test_extractor_converts_amount_to_float(self):
        ...
        state = {"messages": [HumanMessage(content="50000 pesos")]}
