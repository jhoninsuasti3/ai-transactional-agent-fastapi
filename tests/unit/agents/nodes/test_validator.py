...
class TestValidatorNode:
    ...
    def test_failed_validation(self, mock_tool):
        ...
        mock_tool.invoke.return_value = {"valid": False, "error": "Insufficient funds"}
    ...
    def test_validation_with_small_amount(self, mock_tool):
        ...
        mock_tool.invoke.return_value = {"valid": True, "validation_id": "VAL-99999"}
    ...
    def test_validation_with_large_amount(self, mock_tool):
        ...
        mock_tool.invoke.return_value = {"valid": True, "validation_id": "VAL-88888"}
